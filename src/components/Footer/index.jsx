...
const Footer = () => {
    return (
        <div className='px-20 pt-10 pb-20 bg-accent text-center md:text-start md:pt-20'>
            <div className='grid flex-cols-2 gap-4 md:flex md:justify-between mb-20'>
                <div className='grid md:flex gap-3 items-center justify-center'>
                    ...
                    <div>
                        <h1 className='text-primary font-medium text-2xl'>Zuinime</h1>
                        <p className='text-primary'>Website ini dibuat pada tahun 1997, dan dibuat oleh anak muda berdarah turkey</p>
                    </div>
                </div>
